...
public class HelpDialog extends JDialog {
	...
	public HelpDialog() {
    	...
    	label5 = new JLabel("\t New (mnemonik: Alt + N, akcelerator: Ctrl + N) - Dodavanje novog entiteta u sistem (studenta, profesora ili predmeta).\n", new ImageIcon(GlobalConstants.addImg), SwingConstants.LEFT);
    	label6 = new JLabel("\t Close (mnemonik: Alt + C, akcelerator: Ctrl + C) - Zatvaranje aplikacije.\n", new ImageIcon(GlobalConstants.closeImg), SwingConstants.LEADING);
    	label7 = new JLabel("\t 2. Edit (Alt + E)\n");
    	label8 = new JLabel("\t Edit (mnemonik: Alt + E, akcelerator: Ctrl + E) - Izmena postojećeg entiteta (studenta, profesora ili predmeta).\n", new ImageIcon(GlobalConstants.editImg), SwingConstants.LEFT);
    	label9 = new JLabel("\t Delete (mnemonik: Alt + D, akcelerator: Ctrl + D) - Brisanje postojećeg entiteta (studenta, profesora ili predmeta).\n", new ImageIcon(GlobalConstants.delImg), SwingConstants.LEFT);
    	label10 = new JLabel("\t 3. Help (Alt + H)\n");
    	label11 = new JLabel("\t Help (mnemonik: Alt + H, akcelerator: Ctrl + H) -  Prikaz informacija neophodnih za korišćenje aplikacije.\n", new ImageIcon(GlobalConstants.helpImg), SwingConstants.LEFT);
    	label12 = new JLabel("\t About (mnemonik: Alt + A, akcelerator: Ctrl + A) -  Prikaz verzije aplikacije, kao i kratak opis iste. Nakon toga sledi sažeta biografija autora.\n", new ImageIcon(GlobalConstants.aboutImg), SwingConstants.LEFT);
