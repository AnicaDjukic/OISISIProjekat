	...
	public MenuBar() {
		...
		miHelp.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
		    	...
		    	JLabel label3 = new JLabel("\t 1. File (Alt + F)\n");
		    	JLabel label4 = new JLabel(" New (Ctrl + N) - Dodavanje novog entiteta u sistem (studenta, profesora ili predmeta).\n", new ImageIcon("images/add_button.png"), SwingConstants.LEFT);
		    	JLabel label5 = new JLabel(" Close (Ctrl + C) - Zatvaranje aplikacije.\n", new ImageIcon("images/close_button.png"), SwingConstants.LEFT);
		    	JLabel label6 = new JLabel("\t 2. Edit (Alt + E)\n");
		    	JLabel label7 = new JLabel(" Edit (Ctrl + E) - Izmena postojeæeg entiteta (studenta, profesora ili predmeta).\n", new ImageIcon("images/edit_button.png"), SwingConstants.LEFT);
		    	JLabel label8 = new JLabel(" Delete (Ctrl + D) - Brisanje postojeæeg entiteta (studenta, profesora ili predmeta).\n", new ImageIcon("images/bin_button.png"), SwingConstants.LEFT);
		    	JLabel label9 = new JLabel("\t 3. Help (Alt + H)\n");
		    	JLabel label10 = new JLabel(" Help (Ctrl + H) - Prikaz informacije neophodne za korišæenje aplikacije.\n", new ImageIcon("images/help_button.png"), SwingConstants.LEFT);
		    	JLabel label11 = new JLabel(" About (Ctrl + A) -  Prikaz verzije aplikacije, kao i kratak opis iste. Nakon toga sledi sažeta biografija svakog autora.\n", new ImageIcon("images/about_button.png"), SwingConstants.LEFT);
		    	JLabel label12 = new JLabel("Svaka stavka menija ima svoju ikonicu koja se nalazi odmah pored njenog naziva.\n ");
		    	JLabel label13 = new JLabel("Neke od tih ikonica se nalaze i u Tool baru:\n");
		    	JLabel label14 = new JLabel("\t 1. New (Ctrl + N) \n", new ImageIcon("images/add_button.png"), SwingConstants.LEFT);
		    	JLabel label15 = new JLabel("\t 2. Edit (Ctrl + E) \n", new ImageIcon("images/edit_button.png"), SwingConstants.LEFT);
