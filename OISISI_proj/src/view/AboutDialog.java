...
public class AboutDialog extends JDialog {
	...
	public AboutDialog() {
		...
		label3 = new JLabel();
		label4 = new JLabel("\t Aplikacija \"Studentska služba\" omoguæava evidenciju studenata, profesora i predmeta,\t ");
		label5 = new JLabel("\t kako bi olakšala rad šalterskim radnicima studentske službe Fakulteta tehnièkih nauka,\t ");
		label6 = new JLabel("\t Univerziteta u Novom Sadu.");
		label7 = new JLabel();
		label8 = new JLabel("\t Autori: Anica Ðukiæ i Nikola Milosavljeviæ");
